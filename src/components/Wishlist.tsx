...
const Wishlist = ({ id, image, category, sale, title, price, range, sortby, rating}: IProduct) => {
  ...
  return (
    <div className='group cursor-pointer px-8 rounded-full  w-72' onClick={() => router.push(`/details/${id}`)}>
